...
<form class="form-horizontal" role="form" method="post" action="{{url('client/update',['c_id'=>$client->c_id])}}" enctype="multipart/form-data">
@csrf
<div class="form-group">
<h1 class="col-sm-7 control-label">客户修改页面</h1>
	</div>

	<div class="form-group">
		<label for="firstname" class="col-sm-5 control-label">客户名称</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_name" value="{{$client->c_name}}" id="firstname" 
				   placeholder="请输入客户名称">
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_rank" value="{{$client->c_rank}}" id="lastname" 
				   placeholder="请输入客户级别">
    ...
    <div class="form-group">
		...
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_hang" value="{{$client->c_hang}}" id="lastname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_source" value="{{$client->c_source}}" id="lastname" 
				   placeholder="请输入客户来源">
    ...
    <div class="form-group">
		...
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_phone" value="{{$client->c_phone}}" id="firstname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-2">
			<input type="text" class="form-control" name="c_mobile" value="{{$client->c_mobile}}" id="firstname" 
				   placeholder="请输入手机号">
